...
$(KDIR)/root.squashfs: install-prepare
	...
	$(HOST_STAGING_DIR)/bin/mksquashfs-lzma $(KDIR)/root $@ -nopad -noappend -root-owned -$(endian) $(MAKE_TRACE)
...
squashfs-install-ib: compile-targets
	...
	$(CP) $(HOST_STAGING_DIR)/bin/mksquashfs-lzma $(IB_DIR)/staging_dir_$(ARCH)/bin
